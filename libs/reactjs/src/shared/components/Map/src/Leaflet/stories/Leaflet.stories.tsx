...
export default {
  title: 'Shared/Components/Leaflet',
  component: Leaflet,
  argTypes: {},
  parameters: {
    docs: {},
...
} as Meta<typeof Leaflet>;

export const Clustering: StoryFn<typeof Leaflet> = args => (
  <Leaflet<{ name: string }>
    {...args}
...
export const Tracking: StoryFn<typeof Leaflet> = args => (
  <Leaflet
    {...args}
...
export const Planning: StoryFn<typeof Leaflet> = args => (
  <Leaflet
    {...args}
