...
import { MapboxGL } from '../src/MapboxGL';
...
export default {
  title: 'Shared/Components/MapboxGL',
  component: MapboxGL,
  argTypes: {},
  parameters: {
    docs: {},
...
} as Meta<typeof MapboxGL>;

export const Clustering: StoryFn<typeof MapboxGL> = args => (
  <MapboxGL<{ name: string }>
    {...args}
...
export const Tracking: StoryFn<typeof MapboxGL> = args => (
  <MapboxGL
    {...args}
...
export const Planning: StoryFn<typeof MapboxGL> = args => (
  <MapboxGL
    {...args}
